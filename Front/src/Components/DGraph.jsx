...
const DGraph = ({ onVoteComplete, projectId }) => {
    ...
    return (
      <Card className="severity-card" style={{ margin: 0, padding: 0, fontFamily: 'Verdana, sans-serif' }}>
        <CardHeader style={{ margin: 0, padding: '0 0 0 0', textAlign: 'center' }}>
          <CardTitle style={{ color: textColor }}>Loading Severity Factors...</CardTitle>
        </CardHeader>
      </Card>
    )
  }
  ...
  if(error) { 
    return (
      <Card className="severity-card" style={{ margin: 0, padding: 0, fontFamily: 'Verdana, sans-serif' }}>
        <CardHeader style={{ margin: 0, padding: '0 0 0 0', textAlign: 'center' }}>
          <CardTitle style={{ color: textColor }}>Error Fetching Severity Factors</CardTitle>
          <CardDescription style={{ color: textColor }}>{msg}</CardDescription>
        </CardHeader>
      </Card>
    );
  }
    ...
    <Card className="severity-card" style={{ margin: 0, padding: 0, fontFamily: 'Verdana, sans-serif' }}>
      ...
      <CardContent style={{ padding: 0, marginTop: 20, maxHeight: '130vh' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 20, padding: '10px 20px' }}>
          ...
          <button className="refresh-button" onClick={handleRefresh} style={{backgroundColor: '#6b7280', color: 'white', padding: '8px 16px', borderRadius: '8px 16px', borderRadius: '4px', border: 'none', cursor: 'pointer'}}>
            <b>Refresh Data</b>
          </button>
