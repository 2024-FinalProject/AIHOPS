from sqlalchemy import Boolean, Integer, Column, String, Index
...
class DBMember(Base):
    ...
    )  # New field to track Google authentication
    accepted_tac_version = Column(Integer, default=-1)
    profile_picture = Column(String(255), nullable=True)
    profile_picture_source = Column(
        String, default="none"
    )  # 'none', 'google', or 'upload'

    __table_args__ = (Index("idx_member_email", "email"),)
