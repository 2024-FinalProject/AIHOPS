...
def start_session():
    ...
    return jsonify({"success": True, "cookie": str(res.result.cookie)})
...
def register():
    ...
    res = server.register(
        int(data["cookie"]), data["userName"], data["passwd"], int(acceptedTermsVersion)
    )
...
def verify():
    ...
    res = server.verify(
        int(data["cookie"]), data["userName"], data["passwd"], data["code"]
    )
    return jsonify({"message": res.msg, "success": res.success})
...
def update_password():
    data = request.json
    res = server.update_password(
        int(data["cookie"]), data["email"], data["password"], data["code"]
    )
    return jsonify({"message": res.msg, "success": res.success})
...
def create_project():
    data = request.json
    res = server.create_project(
        int(data["cookie"]),
        data["name"],
        data["description"],
        bool(data["defaultFactors"]),
        is_to_research=bool(data["isToResearch"]),
    )
    return jsonify(
        {
            "message": res.msg,
            "success": res.success,
            "project_id": res.result if res.success else None,
        }
    )
...
def add_project_factor():
    data = request.json
    res = server.add_project_factor(
        int(data["cookie"]),
        int(data["pid"]),
        data["factor_name"],
        data["factor_desc"],
        data["scales_desc"],
        data["scales_explanation"],
    )
    return jsonify({"message": res.msg, "success": res.success})
...
def set_project_factors():
    data = request.json
    res = server.set_project_factors(
        int(data["cookie"]), int(data["pid"]), data["factors"]
    )
    return jsonify({"message": res.msg, "success": res.success})
...
def update_project_factor():
    ...
    res = server.update_factor(
        ...
        data["desc"],
        data["scales_desc"],
        data["scales_explenation"],
        bool(data["apply_to_all_inDesign"]),
    )
...
def delete_project_factor():
    data = request.json
    res = server.delete_project_factor(
        int(data["cookie"]), int(data["pid"]), int(data["fid"])
    )
    return jsonify({"message": res.msg, "success": res.success})
...
def set_project_severity_factors():
    data = request.json
    res = server.set_project_severity_factors(
        int(data["cookie"]), int(data["pid"]), data["severityFactors"]
    )
    return jsonify({"message": res.msg, "success": res.success})
    ...
    return jsonify(
        {
            "message": res.msg,
            "success": res.success,
            "factors": res.result if res.success else None,
        }
    )
    ...
    return jsonify(
        {
            "message": res.msg,
            "success": res.success,
            "progress": res.result if res.success else None,
        }
    )
    ...
    return jsonify(
        {
            "message": res.msg,
            "success": res.success,
            "severityFactors": res.result if res.success else None,
        }
    )
...
def update_project_name_and_desc():
    data = request.json
    res = server.update_project_name_and_desc(
        int(data["cookie"]), int(data["pid"]), data["name"], data["description"]
    )
    return jsonify({"message": res.msg, "success": res.success})
    ...
    return jsonify(
        {
            "message": res.msg,
            "success": res.success,
            "members": res.result if res.success else None,
        }
    )
...
def get_projects():
    try:
        ...
        return (
            jsonify({"message": f"Invalid cookie format: {str(e)}", "success": False}),
            400,
        )
    except Exception as e:
        return jsonify({"message": f"Server error: {str(e)}", "success": False}), 500
    ...
    return jsonify(
        {
            "message": res.msg,
            "success": res.success,
            "project": res.result if res.success else None,
        }
    )
    ...
    return jsonify(
        {
            "message": res.msg,
            "success": res.success,
            "requests": res.result if res.success else None,
        }
    )
    ...
    return jsonify(
        {
            "message": res.msg,
            "success": res.success,
            "score": res.result if res.success else None,
        }
    )
...
def vote_on_factor():
    data = request.json
    res = server.vote_on_factor(
        int(data["cookie"]), int(data["pid"]), int(data["factorId"]), int(data["score"])
    )
    return jsonify({"message": res.msg, "success": res.success})
    ...
    return jsonify(
        {
            "message": res.msg,
            "success": res.success,
            "votes": res.result if res.success else None,
        }
    )
...
def admin_update_default_factor():
    data = request.json
    res = server.admin_change_default_factor(
        int(data["cookie"]),
        int(data["fid"]),
        data["name"],
        data["desc"],
...
def admin_add_default_factor():
    data = request.json
    res = server.admin_add_default_factor(
        int(data["cookie"]),
        data["name"],
        data["desc"],
        data["scales_desc"],
...
def fetch_default_severity_factors_full():
    cookie = int(
        request.args.get("cookie", 0)
    )  # fallback to 0 or raise error if missing
...
def admin_update_default_severity_factors():
    data = request.json
    res = server.admin_update_default_severity_factors(
        int(data["cookie"]), data["severity_factors"]
    )
...
def admin_update_terms_and_conditions():
    ...
    res = server.admin_update_terms_and_conditions(
        int(data["cookie"]), data["updatedTXT"]
    )
    return jsonify({"message": res.msg, "success": res.success})
